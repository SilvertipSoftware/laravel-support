...
class InputFieldsTest extends TestCase {
    ...
    public function testTextFieldPlaceholderWithoutTranslation() {
        ...
        $this->assertDomEquals(
            ...
            static::textField('post', 'body', ['placeholder' => true])
        );
    }
    ...
    public function testTextFieldPlaceholderWithTranslation() {
        ...
        $this->assertDomEquals(
            $expected,
            static::textField('post', 'title', ['placeholder' => true])
        );
    }
    ...
    public function testTextFieldPlaceholderWithTranslationAndToModel() {
        ...
        $this->assertDomEquals(
            $expected,
            static::textField('post_delegator', 'title', ['placeholder' => true])
        );
    }
    ...
    public function testTextFieldPlaceholderWithHumanAttributeName() {
        ...
        $this->assertDomEquals(
            $expected,
            static::textField('post', 'cost', ['placeholder' => true])
        );
    }
    ...
    public function testTextFieldPlaceholderWithStringValue() {
        ...
        $this->assertDomEquals(
            ...
            static::textField('post', 'cost', ['placeholder' => 'HOW MUCH?'])
        );
    }
    ...
    public function testTextFieldPlaceholderWithHumanAttributeNameAndValue() {
        ...
        $this->assertDomEquals(
            ...
            static::textField('post', 'cost', ['placeholder' => new Stringable('uk')])
        );
    }
    ...
    public function testTextFieldPlaceholderWithTranslationAndValue() {
        ...
        $this->assertDomEquals(
            $expected,
            static::textField('post', 'written_on', ['placeholder' => new Stringable('spanish')])
        );
    }
    ...
    public function testTextField() {
        $this->assertDomEquals(
          ...
          static::textField("post", "title")
        );
        $this->assertDomEquals(
          '<input id="post_title" name="post[title]" type="password" />',
          static::passwordField("post", "title")
        );
        $this->assertDomEquals(
    ...
    public function testTextFieldWithOptions() {
        ...
        $this->assertDomEquals($expected, static::textField('post', 'title', ['size' => 35]));
    }
    ...
    public function testTextFieldAssumingSize() {
        ...
        $this->assertDomEquals($expected, static::textField('post', 'title', ['maxlength' => 35]));
    }
    ...
    public function testTextFieldRemovingSize() {
        ...
        $this->assertDomEquals($expected, static::textField('post', 'title', ['maxlength' => 35, 'size' => null]));
    }
    ...
    public function testTextFieldWithNullName() {
        $this->assertDomEquals(
            ...
            static::textField('post', 'title', ['name' => null])
        );
    }
    ...
    public function testTextFieldDoesntChangeParamValues() {
        ...
        $this->assertDomEquals($expected, static::textField($objectName, 'title'));
    }
    ...
    public function testCheckBoxCheckedIfObjectValueSameAsCheckedValue() {
        ...
        $this->assertDomEquals($expected, static::checkBox('post', 'secret'));
    }
    ...
    public function testCheckBoxWithIncludeHiddenFalse() {
        ...
        $this->assertDomEquals($expected, static::checkBox('post', 'secret', ['include_hidden' => false]));
    }
    ...
    public function testCheckBoxWithStringObjectValues() {
        ...
        $this->assertDomEquals($expected, static::checkBox('post', 'secret', [], 'on', 'off'));
    ...
    public function testCheckBoxWithBooleanObjectValues() {
        ...
        $this->assertDomEquals($expected, static::checkBox('post', 'secret', [], false, true));
    ...
    public function testCheckBoxWithIntegerObjectValues() {
        ...
        $this->assertDomEquals($expected, static::checkBox('post', 'secret', [], 0, 1));
    ...
    public function testCheckBoxWithNullUncheckedValue() {
        ...
        $this->assertDomEquals($expected, static::checkBox('post', 'secret', [], 'on', null));
    }
    ...
    public function testCheckBoxWithMultipleBehavior() {
        ...
        $this->assertDomEquals($expected, static::checkBox('post', 'comment_ids', ['multiple' => true], 1));

        $expected = '<input name="post[comment_ids][]" type="hidden" value="0" autocomplete="off" />'
            . '<input checked="checked" id="post_comment_ids_3" name="post[comment_ids][]" type="checkbox" value="3" />';
        $this->assertDomEquals($expected, static::checkBox('post', 'comment_ids', ['multiple' => true], 3));
    }
    ...
    public function testCheckBoxWithMultipleBehaviorAndIndex() {
        ...
        $this->assertDomEquals(
            $expected,
            static::checkBox('post', 'comment_ids', ['multiple' => true, 'index' => 'foo'], 1)
        );

        $expected = '<input name="post[bar][comment_ids][]" type="hidden" value="0" autocomplete="off" />'
            . '<input checked="checked" id="post_bar_comment_ids_3" name="post[bar][comment_ids][]" type="checkbox" value="3" />';
        $this->assertDomEquals(
            $expected,
            static::checkBox('post', 'comment_ids', ['multiple' => true, 'index' => 'bar'], 3)
        );
    }

    public function testCheckBoxDisabledDisablesHiddenField() {
        ...
        $this->assertDomEquals($expected, static::checkBox("post", "secret", ['disabled' => true]));
    }
    ...
    public function testCheckBoxHtml5FormAttribute() {
        $expected = '<input form="new_form" name="post[secret]" type="hidden" value="0" autocomplete="off" />'
            ...
            . ' type="checkbox" value="1" />';
        $this->assertDomEquals($expected, static::checkBox('post', 'secret', ['form' => 'new_form']));
    }

    public function testColorFieldWithValidHexString() {
        $expected = '<input id="car_color" name="car[color]" type="color" value="#000fff" />';
        $this->assertDomEquals($expected, static::colorField('car', 'color'));
    }
    ...
    public function testDatetimeField() {
        ...
        $this->assertDomEquals($expected, static::datetimeField('post', 'written_on'));
    }
    ...
    public function testDatetimeLocalField() {
        $expected = '<input id="post_written_on" name="post[written_on]" type="datetime-local"'
            . ' value="2004-06-15T00:00:00" />';
        $this->assertDomEquals($expected, static::datetimeLocalField('post', 'written_on'));
    }
    ...
    public function testHiddenFieldWithEscapes() {
        ...
        $this->assertDomEquals($expected, static::hiddenField('post', 'title'));
    }
    ...
    public function testMonthField() {
        ...
        $this->assertDomEquals($expected, static::monthField('post', 'written_on'));
    }
    ...
    public function testRadioButton() {
        $expected = '<input checked="checked" id="post_title_hello_world" name="post[title]" type="radio"'
            . ' value="Hello World" />';
        $this->assertDomEquals($expected, static::radioButton('post', 'title', 'Hello World'));
    ...
    public function testRadioButtonCheckedWithIntegers() {
        $this->assertDomEquals(
            ...
            static::radioButton('post', 'secret', "1")
        );
    }
    ...
    public function testRadioButtonRespectsPassedInId() {
        $this->assertDomEquals(
            ...
            static::radioButton('post', 'secret', '1', ['id' => 'foo'])
        );
    }
    ...
    public function testRadioButtonWithBooleans() {
        ...
        $this->assertDomEquals(
            ...
            static::radioButton('post', 'secret', true)
        );

        $this->assertDomEquals(
            '<input id="post_secret_false" name="post[secret]" type="radio" value="false" />',
            static::radioButton('post', 'secret', false)
        );
    }
    ...
    public function testTelField() {
        ...
        $this->assertDomEquals($expected, static::telField('user', 'cell'));
    }
    ...
    public function testTextAreaPlaceholderWithoutTranslations() {
        ...
        $this->assertDomEquals($expected, static::textArea('post', 'body', ['placeholder' => true]));
    }
    ...
    public function testTextAreaPlaceholderWithTranslations() {
        ...
        $this->assertDomEquals($expected, static::textArea('post', 'title', ['placeholder' => true]));
    }
    ...
    public function testTextAreaPlaceholderWithHumanAttributeName() {
        ...
        $this->assertDomEquals($expected, static::textArea('post', 'cost', ['placeholder' => true]));
    }
    ...
    public function testTextAreaPlaceholderWithStringValue() {
        ...
        $this->assertDomEquals($expected, static::textArea('post', 'cost', ['placeholder' => 'HOW MUCH?']));
    }
    ...
    public function testTextAreaPlaceholderWithHumanAttributeNameAndValue() {
        ...
        $this->assertDomEquals($expected, static::textArea('post', 'cost', ['placeholder' => new Stringable('uk')]));
    }
    ...
    public function testTextAreaPlaceholderWithTranslationsAndValue() {
        ...
        $this->assertDomEquals(
            $expected,
            static::textArea('post', 'written_on', ['placeholder' => new Stringable('spanish')])
        );
    }
    ...
    public function testTextArea() {
        $expected = '<textarea id="post_body" name="post[body]">'
            . "\n" . 'This is a post</textarea>';
        $this->assertDomEquals($expected, static::textArea('post', 'body'));
    }
    ...
    public function testTextAreaWithSizeOption() {
        ...
        $this->assertDomEquals($expected, static::textArea('post', 'body', ['size' => '183x820']));
    }

    public function testTimeField() {
        $expected = '<input id="post_written_on" name="post[written_on]" type="time" value="00:00:00" />';
        $this->assertDomEquals($expected, static::timeField('post', 'written_on'));
    }
    ...
    public function testWeekField() {
        ...
        $this->assertDomEquals($expected, static::weekField('post', 'written_on'));
    ...
    public function testExplicitName() {
        $this->assertDomEquals(
            ...
            static::textField('post', 'title', ['name' => 'dont guess'])
        );

        $this->assertDomEquals(
            '<textarea id="post_body" name="really!">' . "\n" . 'This is a post</textarea>',
            static::textArea('post', 'body', ['name' => 'really!'])
        );
        ...
        $this->assertDomEquals(
            ...
            static::checkBox('post', 'secret', ['name' => 'i mean it'])
        );
    }
    ...
    public function testExplicitId() {
        $this->assertDomEquals(
            ...
            static::textField('post', 'title', ['id' => 'dont guess'])
        );

        $this->assertDomEquals(
            '<textarea id="really!" name="post[body]">' . "\n" . 'This is a post</textarea>',
            static::textArea('post', 'body', ['id' => 'really!'])
        );
        ...
        $this->assertDomEquals(
            ...
            static::checkBox('post', 'secret', ['id' => 'i mean it'])
        );
    }
    ...
    public function testNullId() {
        $this->assertDomEquals(
            ...
            static::textField('post', 'title', ['id' => null])
        );

        $this->assertDomEquals(
            '<textarea name="post[body]">' . "\n" . 'This is a post</textarea>',
            static::textArea('post', 'body', ['id' => null])
        );

        $this->assertDomEquals(
            '<input name="post[secret]" type="hidden" value="0" autocomplete="off" />'
            . '<input checked="checked" name="post[secret]" type="checkbox" value="1" />',
            static::checkBox('post', 'secret', ['id' => null])
        );

        $this->assertDomEquals(
            '<input type="radio" name="post[secret]" value="0" />',
            static::radioButton('post', 'secret', '0', ['id' => null])
        );
    }
}
